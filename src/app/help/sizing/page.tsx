    ...
    <div className="min-h-[70vh] bg-white">
      <div className="container-bj py-16">
        ...
        <div className="max-w-2xl">
          <h1 className="font-display text-[2rem] tracking-[0.05em] text-bj-black uppercase mb-6">Size Guide</h1>
          <p className="text-body text-bj-gray-500 mb-10">Find your perfect fit with our comprehensive ring, bracelet, and necklace sizing guides.</p>
