    ...
    <div className="min-h-[70vh] bg-white">
      <div className="container-bj py-16">
        <nav className="flex items-center gap-2 text-[12px] text-bj-gray-400 mb-10">
          ...
          <span>/</span>
          <span className="text-bj-black">Press</span>
        </nav>
        <div className="max-w-2xl">
          <h1 className="font-display text-[2rem] tracking-[0.05em] text-bj-black uppercase mb-6">Press</h1>
          <p className="text-body text-bj-gray-500 mb-10">Media inquiries, press kits, and brand assets. We love sharing the Bonjoojoo story.</p>
